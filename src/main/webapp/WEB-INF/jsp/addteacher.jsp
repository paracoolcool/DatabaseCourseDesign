...
<body>
<form class="layui-form" action="${pageContext.request.contextPath}/teacher/add" method="post" >
    <div class="layui-form-item">
        <label class="layui-form-label">教工号</label>
        <div class="layui-input-inline">
            <input type="text" name="teacherid" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input" id="studentid">
        </div>
    </div>
    <div class="layui-form-item">
